(function() {
  ...
  const apiKey = 'key-f740d2cbc40cb72e3c00dc229d3ee613';
  const domain = 'www.bryanbrophy.com';
  const fromWho = 'get@bryanbrophy.com';
  ...
  router.post('/users', ev(validations.post), (req, res, next) => {
    ...
    .then((usersInserted) => {
      ...
      const data = {
        ...
        text: `Hey, ${name}!\n\nThank you for registering for Addressing Room!
        You are a true soldier, and we salute you, dawg.\n\nHugs and
